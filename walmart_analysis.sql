...
-- Q9. What product category had the largest value-added tax (VAT)?
...
/*  Q10. Retrieve each product category and include a column indicating whether 
...
-- Q11. Which branch sold more products than the overall average product sold?
...
-- Q12. What is the most common product category by gender?
...
-- Q13. What is the average rating within each product category?
...
-- Q14. How many unique customer category does the data have in total?

SELECT DISTINCT
	customer_category
FROM sales;

-- Q15. How many unique payment methods does the data have in total?

SELECT DISTINCT
	payment_type
FROM sales;

-- Q16. What is the most common customer category?
...
-- Q17. Which gender constitutes the majority of the customer base?
...
-- Q18. Which customer category purchases the most items?
...
-- Q20. Which time of the day do customers give the most ratings?
...
-- Q21. Which time of the day do customers give the most ratings per branch?
...
-- Q22. Which day of the week has the best avg ratings?
...
-- ----------------------Sales Questions ------------------------------
 ...
 /* Q24. What is the number of transactions conducted during each time
...
-- Q25. Which of the customer category brings the most revenue?
...
-- Q27. Which customer category pays the most in VAT?
